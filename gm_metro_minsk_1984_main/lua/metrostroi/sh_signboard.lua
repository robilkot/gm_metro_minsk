...
--	Аддон добавляет плакат первое поезди на составы 81-717 серии (общая часть).
--	Автор: 	klusandr
...
hook.Add("InitPostEntity", "SignboardInitializeShared", function()       --Хук, вызываемый после инциализации игры, начало тела функции с кодом
...
for _, trainName in pairs(Trains) do
	...
	table.insert(Train.Spawner, (spawnTablePos or #Train.Spawner) - 1, {"Signboard", "Плакат", "Boolean"})
end
