...
timer.Simple(3, function()
    ...
    concommand.AddClientView("metrostroi_current_limit_feeder", currentLimitAutoComplete, "Set the current limit on the feeder.\n   Arguments:\n\t- Feeder number.\n\t- Value.", true)
    ...
    concommand.AddClientView("metrostroi_feeder_info", nil, "Print actual information for all feeders.")
    concommand.AddClientView("metrostroi_feeder_config", nil, "Print configuration for all feeders.")
    concommand.AddClientView("metrostroi_feeder_train_info", nil, "Print train binding to the feeders. The train must be in the center of your sight.")

    concommand.AddClientView("minsk_mk_lock", nil, "Lock all MK control buttons.", true)
    concommand.AddClientView("minsk_mk_unlock", nil, "Unlock all MK control buttons.", true)

    concommand.AddClientView("picket_tp", nil, "Teleport to specified picket.\n   Arguments:\n\t- Left picket number.\n\t- Right picket number.")
end)